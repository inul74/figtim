...
export default function Sidebars({
  ...
  return (
    <>
      {/* Left Sidebar */}
      {!leftIsMinimized ? (
        <div className="fixed left-0 flex h-screen w-[250px] flex-col border-r border-gray-200 bg-white">
          <div className="p-4">
        ...
        <div className="fixed left-2 top-2 flex h-[48px] w-[250px] items-center justify-between rounded-xl border bg-white p-4">
          <Link href="/dashboard">
            <img src="/logo.svg" alt="Flogo" className="h-[24px] w-[24px]" />
          </Link>
